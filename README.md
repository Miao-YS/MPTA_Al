...
python spatial_registration.py \
  ...
  --spacing 2.6608 2.6608 2.6608
```

For Windows Command Prompt, the command can be entered on one line:

```bash
python spatial_registration.py --reference-dir data/reference --moving-dir data/moving --output-dir results/registered --spacing 2.6608 2.6608 2.6608
```
...
python micropore_parameter_calculation.py \
  ...
  --voxel-size 2.6608 2.6608 2.6608 \
  --threshold 0 \
  --min-voxels 6 \
  --group-name S1
```
...
```bash
python micropore_parameter_calculation.py --input-dir data/binary_stage_1 --output-csv results/parameters/stage_1_parameters.csv --voxel-size 2.6608 2.6608 2.6608 --threshold 0 --min-voxels 6 --group-name S1
```
